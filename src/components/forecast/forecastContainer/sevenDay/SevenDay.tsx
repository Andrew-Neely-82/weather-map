import { CloudyDayOne, IsolatedStorms, LightRain, Lightning, PartlyCloudy, Rain } from "../../assets/svg/export";
...
const SevenDay: React.FC = () => {
  ...
  return (
    <div className="SevenDay__">
      ...
      <Days style={titleStyle} day={"Tue"} condition={<IsolatedStorms />} temp={10} />
